...
# testing the methods of TF_IDF to determine which is better

# candidates of number of features
...
{}
        {:<17}  {:<17}
####### #################  #################
# NOF # #  most # least #  #  most # least #
####### #################  #################""".format(models_string[counter],"accuracy","f1"))
    for num_feature in num_features:
        
        time_start = time.time()
        # data loading 
        df_1 = pd.read_csv("../../../Data/Testing/TF-IDF/BOW_base_tf-idf_most_{}.csv".format(num_feature))
        ...
        # predict and metrics calculation
...
################################################################################################################################################
        ...
        time_start = time.time()
        # data loading 
        df_2 = pd.read_csv("../../../Data/Testing/TF-IDF/BOW_base_tf-idf_least_{}.csv".format(num_feature))
